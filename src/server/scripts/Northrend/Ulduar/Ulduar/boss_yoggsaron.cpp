...
enum Sara_Yells
{
    SAY_SARA_PREFIGHT_1                         = 0,
    SAY_SARA_PREFIGHT_2                         = 1,
    SAY_SARA_AGGRO_1                            = 2,
    SAY_SARA_AGGRO_2                            = 3,
    SAY_SARA_AGGRO_3                            = 4,
    SAY_SARA_SLAY_1                             = 5,
    SAY_SARA_SLAY_2                             = 6,
    WHISP_SARA_INSANITY                         = 7,
    SAY_SARA_PHASE2_1                           = 8,
    SAY_SARA_PHASE2_2                           = 9
};
...
enum YoggSaron_Yells
{
    ...
    SAY_PHASE3                                  = 5,
    SAY_VISION                                  = 6,
    SAY_LUNCATIC_GLAZE                          = 7,
    SAY_DEAFENING_ROAR                          = 8,
    WHISP_INSANITY_1                            = 9,
    WHISP_INSANITY_2                            = 10,
    SAY_DEATH                                   = 11
};
...
{
    // King Llane
    SAY_GARONA_1_VISION_1                       = 0,
    SAY_GARONA_2_VISION_1                       = 1,
    SAY_GARONA_3_VISION_1                       = 2,
    SAY_YOGGSARON_4_VISION_1                    = 3,
    SAY_YOGGSARON_5_VISION_1                    = 4,
    SAY_LLANE_6_VISION_1                        = 5,
    SAY_GARONA_7_VISION_1                       = 6,
    SAY_YOGGSARON_8_VISION_1                    = 7,
    // Lichking
    SAY_LICHKING_1_VISION_2                     = 8,
    SAY_CHAMP_2_VISION_2                        = 9,
    SAY_CHAMP_3_VISION_2                        = 10,
    SAY_LICHKING_4_VISION_2                     = 11,
    SAY_YOGGSARON_5_VISION_2                    = 12,
    SAY_YOGGSARON_6_VISION_2                    = 13,
    // Dragon Soul
    SAY_NELTHARION_1_VISION_3                   = 14,
    SAY_YSERA_2_VISION_3                        = 15,
    SAY_NELTHARION_3_VISION_3                   = 16,
    SAY_MALYGOS_4_VISION_3                      = 17,
    SAY_YOGGSARON_5_VISION_3                    = 18
};
...
public:
    ...
    struct boss_saraAI : public ScriptedAI
    {
        ...
        void SaraRandomYell()
        {
            switch(m_Phase)
            {
            case PHASE_NONE: Talk(RAND(SAY_SARA_PREFIGHT_1,SAY_SARA_PREFIGHT_2)); break;
            case PHASE_SARA: Talk(RAND(SAY_SARA_AGGRO_2,SAY_SARA_AGGRO_3)); break;
            case PHASE_BRAIN: Talk(RAND(SAY_SARA_PHASE2_1,SAY_SARA_PHASE2_2,SAY_SARA_AGGRO_3)); break;
            }
        }
        ...
        uint32 DoEventSpeaking(BrainEventPhase phase, uint32 part)
        {
            ...
            if(Creature* speaker = Creature::GetCreature(*me,npcguid))
                Talk(EventNpcSpeaching[speachindex+part].speech_entry);
            ...
            switch(m_Phase)
            {
                ...
                case PHASE_BRAIN:
                    ...
                    }else
                    {
                        ...
                        {
                            if(Creature* yoggbrain = me->GetCreature(*me,guidYoggBrain))
                                if(!yoggbrain->IsNonMeleeSpellCast(false))
                                {
                                    if(Creature* yogg = me->GetCreature(*me,guidYogg))
                                        yogg->RemoveAurasDueToSpell(SPELL_SHATTERED_ILLUSIONS);
                                    me->RemoveAurasDueToSpell(SPELL_SHATTERED_ILLUSIONS);
...
public:
    ...
    {
        npc_brain_of_yogg_saronAI(Creature *c) : ScriptedAI(c)
        {
            m_pInstance = c->GetInstanceScript();
            me->SetReactState(REACT_PASSIVE);
            me->setFaction(14);
